...
new class extends Component {
    ...
    {
        // Get booked dates for this yacht, excluding current booking
        $bookings = Booking::where('bookingable_type', Yacht::class)
    ...
    public function cancelBooking(): void
    {
        ...
        $this->showCancelModal = false;
        $this->success('Booking cancelled successfully.' . ($this->refund_amount ? " Refund of {$this->refund_amount} added to customer's wallet." : ''), redirectTo: route('admin.bookings.yacht.index'));
    }
        ...
        <div class="space-y-4">
            ...
            @if (count($bookedDates) > 0)
                <x-alert title="Booked Dates Info"
                    ...
                    icon="o-exclamation-triangle" class="alert-warning" />
            @else
                <x-alert title="No Conflicts" description="All dates are currently available for this yacht."
