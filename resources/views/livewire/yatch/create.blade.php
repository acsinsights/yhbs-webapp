...
new class extends Component {
    ...
    public function save(): void
    {
        $validated = $this->validate([
            ...
            'slug' => 'required|string|max:255|unique:yatches,slug',
        ...
        $yatch = new Yatch();
        $yatch->name = $validated['name'];
        $yatch->slug = $validated['slug'];
        $yatch->description = $validated['description'];
...
<div>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-4">
            <div class="p-3 rounded-xl bg-gradient-to-br from-primary/20 to-primary/10">
                <x-icon name="o-plus-circle" class="w-8 h-8 text-primary" />
            </div>
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                    Create New Yacht
                </h1>
                <p class="text-sm text-base-content/60 mt-1">Add a new yacht to your collection</p>
            </div>
        </div>
        <div class="breadcrumbs text-sm">
            <ul>
                ...
                <li class="text-primary font-semibold">Create</li>
            </ul>
        </div>
    </div>
    ...
    <x-card shadow class="border-2 border-primary/20 overflow-hidden">
        <!-- Card Header -->
        <div class="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent p-4 border-b border-primary/20">
        ...
        <x-form wire:submit="save" class="p-6">
                        ...
                        <div class="card-body p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-base-content/60">Upload a high-quality cover image for your
                                        yacht</p>
                                </div>
                            </div>
                            <x-file label="" wire:model="image" accept="image" crop-after-change
                                ...
                                <div class="mt-4">
                                    <div class="relative group">
                                        <div
                                            class="absolute inset-0 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-xl blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        </div>
                                        <img id="imagePreview" src="https://placehold.co/800x400?text=Cover+Image"
                                            class="relative w-full h-48 object-cover rounded-xl border-2 border-primary/20 shadow-md group-hover:border-primary/40 transition-all duration-300"
                                        ...
                                        <div
                                            ...
                                            <div class="text-center">
                                                <x-icon name="o-camera" class="w-8 h-8 text-primary mx-auto mb-2" />
                                                <p class="text-sm font-semibold text-primary">Click to upload</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card bg-gradient-to-br from-primary/5 to-primary/10 border-2 border-primary/20">
                        <div class="card-body p-4">
                            <h4 class="font-semibold mb-2 flex items-center gap-2">
                                <x-icon name="o-light-bulb" class="w-5 h-5 text-primary" />
                                Pro Tip
                            </h4>
                            <p class="text-sm text-base-content/70">
                                Make sure to add a high-quality image and detailed description to attract more
                                customers.
                            </p>
                        </div>
                    </div>
            ...
            <x-slot:actions>
                <div class="flex justify-between w-full items-center">
                    <x-button label="Cancel" link="{{ route('admin.yatch.index') }}"
                        class="btn-ghost hover:btn-error transition-all duration-300" icon="o-x-mark" />
                    <x-button label="Create Yacht"
                        class="btn-primary btn-lg shadow-lg hover:shadow-xl transition-all duration-300"
