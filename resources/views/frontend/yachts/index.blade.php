            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="hotel-grid-top-area mb-4">
                        <span><strong>{{ $yachts->total() }}</strong> Yachts Available</span>
                    </div>
                                        ...
                                        <div class="hotel-content">
                                            ...
                                            <div class="location-area mb-3">
                                                <div class="location">
                                                    ...
                                                    <span>Capacity: {{ $yacht->max_guests ?? 0 }} guests</span>
                                                </div>
                                            </div>

                                            @if ($yacht->amenities && $yacht->amenities->count() > 0)
                                                <ul class="hotel-feature-list mb-3">
                                                    @foreach ($yacht->amenities->take(4) as $amenity)
                                                        <li>
                                                            <svg width="14" height="14" viewBox="0 0 14 14"
                                                                xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="btn-and-price-area">
                                                ...
                                                <div class="price-area">
                                                    <h6>Per Day</h6>
                                                    <span>{{ currency_format($yacht->price) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
