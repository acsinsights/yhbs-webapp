...
@section('content')
  <!-- Breadcrumb section Start-->
    <div class="breadcrumb-section three" style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/breadcrumb-bg6.jpg);">
        <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="list-grid-product-wrap">
                        <div class="row gy-md-5 gy-4">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="assets/img/innerpages/hotel-img6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="hotel-content">
                                        <div class="rating-area">
