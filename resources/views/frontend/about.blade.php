...
@section('content')
            ...
            <div class="about-wrapper">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6 col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about-content">
                            <div class="section-title">
                                <h2>Why We’re Best Marine Services Company</h2>
                                <h4>
                                    Welcome to IKARUS United Marine Services – Your Gateway to Premium Marine & Tourism
                                    Experiences!
                                </h4>
                                <p>
                                    IKARUS United Marine Services is one of the leading names in marine tourism and coastal
                                    leisure, offering hotel stays, heritage village rentals, sea cruises, and a wide range
                                    of marine services. With a trained team, modern fleet, and years of expertise, we ensure
                                    smooth operations and unforgettable experiences for every visitor.

                                    Established in 2013, IKARUS now operates 27 marine vessels, manages a yacht club, and
                                    provides essential solutions such as docking, maintenance, and fueling. Our heritage
                                    facilities at Failaka Island give guests a unique blend of culture, comfort, and coastal
                                    adventure—making every visit memorable
                                </p>
                                <p>
                                    We believe marine tourism is not just about reaching a destination—it’s about
                                    experiencing the sea, discovering new emotions, and creating lasting memories.
                                </p>
                            </div>
                            <div class="founder-area">
                                <img src="assets/img/innerpages/about-page-founder-signature.png" alt="" />
                                <div class="founder-info">
                                    <h6>Khalid Al Sharrad</h6>
                                    <span>Chairman at IKARUS United Marine Services</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 d-lg-block d-none wow animate fadeInRight" data-wow-delay="200ms"
                        ...
                        <div class="about-img">
                            <img src="{{ asset('frontend/img/home3/about-img.png') }}" alt="" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="service-wrapper">
                <div class="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms"
                    ...
                    <div class="col-lg-9">
                        <div class="section-title">
                            <h2>We’re Providing the Best Marine Services Ever!</h2>
                ...
                <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <li class="single-service">
                        ...
                        <div class="content">
                            ...
                            <p>Experienced crew ensuring safe & reliable marine operations.</p>
                        </div>
                    </li>
                    <li class="single-service">
                        <div class="icon">
                        ...
                        <div class="content">
                            <h4> Quality Fleet & Services</h4>
                            <p>
                                Well-maintained vessels with complete marine solutions in one place.
                            </p>
                        </div>
                    </li>
                    <li class="single-service">
                        ...
                        <div class="content">
                            ...
                            <p>
                                Transparent pricing for smooth, budget-friendly marine trips.
                            </p>
                        </div>
                    </li>
                </ul>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                ...
                <div class="col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>
                            A dedicated evolution of marine services, island tourism, and coastal experiences since 2013.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-8 col-lg-10">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-one" role="tabpanel"
                                ...
                                <h4>2013 — Company Founded</h4>
                                <p>IKARUS United Marine Services was officially established, beginning its journey in marine
                                    tourism and coastal activities.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="pills-two" role="tabpanel" aria-labelledby="pills-two-tab">
                                <h4>2015 — Heritage Village & Failaka Operations</h4>
                                <p>The company expanded services by managing heritage village stays, beach experiences, and
                                    cultural tourism on Failaka Island.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="pills-three" role="tabpanel"
                                aria-labelledby="pills-three-tab">
                                <h4>2018 — Fleet & Services Expansion</h4>
                                <p>
                                    IKARUS strengthened its marine operations by adding more vessels, introducing sea
                                    cruises, boat rentals, and professional marine crew services.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="pills-four" role="tabpanel" aria-labelledby="pills-four-tab">
                                <h4>2021 — Full Marine Solutions Introduced</h4>
                                <p>Docking facilities, maintenance workshops, fueling services, and mid-range yacht support
                                    were added to provide complete marine solutions.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="pills-five" role="tabpanel" aria-labelledby="pills-five-tab">
                                <h4>2023 — 26-Vessel Fleet & 200+ Staff</h4>
                                <p>
                                    The company grew into a leading marine service provider, operating 27 vessels with a
                                    skilled workforce of over 200 dedicated members.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="pills-six" role="tabpanel" aria-labelledby="pills-six-tab">
                                <h4>2024 — Offshore Services Expansion</h4>
                                <p>
                                    2024 — Offshore Services Expansion

                                    IKARUS initiated advanced offshore marine service plans, enhancing cargo support, crew
                                    transportation, and long-route marine operations.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="pills-seven" role="tabpanel"
                                aria-labelledby="pills-seven-tab">
                                <h4>2025 — Digital Transformation & Service Upgrade</h4>
                                <p>
                                    The company focused on modernizing booking systems, improving customer experience, and
                                    introducing new safety and operational standards across all marine activities.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="about-video-section mb-100">
        <div class="container">
            <div class="video-wrap">
                <img src="{{ asset('frontend/img/innerpages/about-video-img.jpg') }}" alt="" />
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    ...
                                    <div class="content">
                                        <p>
                                            Our honeymoon package to the Maldives was beyond
                                            amazing! The travel agency took care of every detail.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-card two">
                                    ...
                                    <div class="content">
                                        <p>
                                            This was the best trip of my life! Everything was
                                            perfectly planned, from airport pickup to guided tours.
                                            The accommodations were fantastic, and the itinerary was
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    ...
                                    <div class="content">
                                        <p>
                                            The tour was well-organized, and we enjoyed every bit of
                                            it. However, I wish we had more free time to explore on
                                            our own. Overall, a great experience!
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    ...
                                    <div class="content">
                                        <p>
                                            Thank you so much for your work on our honeymoon. We
                                            really did have such a great time and it was everything
                                            we were hoping!
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card two">
                                    ...
                                    <div class="content">
                                        <p>
                                            We have returned from Greece and want to let you know
                                            how terrific the trip was! Everything was great. We
                                            highly recommend them. Thank you so much!
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="200ms"
                                ...
                                <h5 class="accordion-header" id="flush-headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        What services does IKARUS Marine offer?
                                    </button>
                                </h5>
                                <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                    aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        IKARUS provides marine tourism, sea cruises, heritage village stays, docking,
                                        maintenance, fueling, and boat/yacht services.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms"
                                ...
                                <div id="flush-collapseFour" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        Heritage village stays, restaurants, beach access, and cultural tourism experiences.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms"
                            ...
                            <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms"
                                ...
                                <h5 class="accordion-header" id="flush-headingSix">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is the main focus of IKARUS Marine?
                                    </button>
                                </h5>
    ...
    <div class="counter-section">
        <div class="container">
            <div class="row gy-md-5 gy-4 align-items-stretch justify-content-between">
                <div class="col-lg-3 col-sm-6 divider d-flex justify-content-lg-center">
                    <div class="single-counter">
                        ...
                        <div class="content">
                            ...
                            <span>Marine Vessels Operated</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 divider d-flex justify-content-lg-center">
                    <div class="single-counter">
                        ...
                        <div class="content">
                            ...
                            <span>Skilled Staff Members</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 divider d-flex justify-content-lg-center">
                ...
                <div class="col-lg-3 col-sm-6 divider d-flex justify-content-lg-center">
                    <div class="single-counter">
                        ...
                        <div class="content">
                            ...
                            <span>Happy Passengers & Visitors</span>
                        </div>
                    </div>
                </div>
            </div>
