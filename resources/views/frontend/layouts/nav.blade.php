                    ...
                    <ul class="menu-list">
                        ...
                        <li class="menu-item-has-children position-inherit">
                            ...
                            <div class="mega-menu">
                                    ...
                                    <div class="menu-row">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/france-flag.png') }}"
                                                            alt="">
                                                        Paris, France
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/uk-flag.png') }}"
                                                            alt="">
                                                        United Kingdom
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/netherland-flag.png') }}"
                                                            alt="">
                                                        Netherlands
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/italy-flag.png') }}"
                                                            alt="">
                                                        Italy
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/greece-flag.png') }}"
                                                            alt="">
                                                        Greece
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/romania-flag.png') }}"
                                                            alt="">
                                                        Romania
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-single-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/japan-flag2.png') }}"
                                                            alt="">
                                                        Tokyo, Japan
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/indonesia-flag.png') }}"
                                                            alt="">
                                                        Indonesia
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/thailand-flag.png') }}"
                                                            alt="">
                                                        Thailand
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/malaysia-flag.png') }}"
                                                            alt="">
                                                        Malaysia
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/vietnam-flag.png') }}"
                                                            alt="">
                                                        Hanoi, Vietnam
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/india-flag.png') }}"
                                                            alt="">
                                                        India
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-single-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/egypt-flag.png') }}"
                                                            alt="">
                                                        Egypt
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/south-africa-flag.png') }}"
                                                            alt="">
                                                        South Africa
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/zimbabwe-flag.png') }}"
                                                            alt="">
                                                        Zimbabwe
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/kenya-flag.png') }}"
                                                            alt="">
                                                        Kenya
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/morocco-flag.png') }}"
                                                            alt="">
                                                        Morocco
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/senegal-flag.png') }}"
                                                            alt="">
                                                        Senegal
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-single-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/australia-flag.png') }}"
                                                            alt="">
                                                        Australia
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/papua-new-guinea-flag.png') }}"
                                                            alt="">
                                                        Papua New Guinea
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-single-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/uae-flag.png') }}"
                                                            alt="">
                                                ...
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/qatar-flag.png') }}"
                                                            alt="">
                                                        Qatar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/bahrain-flag.png') }}"
                                                            alt="">
                                                        Bahrain
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/saudi-arabia-flag.png') }}"
                                                            alt="">
                                                        Saudi Arabia
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/jordan-flag.png') }}"
                                                            alt="">
                                                        Jordan
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/palestine-flag.png') }}"
                                                            alt="">
                                                        Palestine
                                                    </a>
                                                </li>
                                        ...
                                        <div class="menu-single-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/us-flag.png') }}"
                                                            alt="">
                                                        United States
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/canada-flag.png') }}"
                                                            alt="">
                                                        Canada
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/mexico-flag.png') }}"
                                                            alt="">
                                                        Mexico
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/jamaica-flag.png') }}"
                                                            alt="">
                                                        Jamaica
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="destination-details.html">
                                                        <img src="{{ asset('frontend/img/home1/costa-rica-flag.png') }}"
                                                            alt="">
                                                        Costa Rica
                                                    </a>
                                                </li>
                                ...
                                <img src="{{ asset('frontend/img/home1/mega-menu-vector1.svg') }}" alt=""
                                    class="vector1">
                                <img src="{{ asset('frontend/img/home1/mega-menu-vector2.svg') }}" alt=""
                                    class="vector2">
                            </div>
                        </li>
            ...
            <div class="nav-right">
                ...
                @else
                    ...
                    <div class="auth-buttons d-xl-flex d-none" style="gap: 10px;">
                        <a href="{{ route('customer.login') }}" class="primary-btn1 black-bg">
                            <span>
                                <svg width="15" height="15" viewbox="0 0 15 15"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
                        ...
                        <a href="{{ route('customer.register') }}" class="primary-btn1"
