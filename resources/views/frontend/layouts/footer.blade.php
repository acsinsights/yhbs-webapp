                      ...
                      <div class="footer-logo-and-addition-info">
                          ...
                          <div class="language-area">
                              ...
                              <ul class="language-list">
                                  <li><a href="#"><img src="{{ asset('frontend/img/home1/england-flag.png') }}"
                                              alt="">English</a></li>
                                  <li><a href="#"><img
                                              src="{{ asset('frontend/img/home1/netherlands-flag.png') }}"
                                              alt="">Dutch</a></li>
                                  <li><a href="#"><img src="{{ asset('frontend/img/home1/japan-flag.png') }}"
                                              alt="">Japanese</a></li>
                                  <li><a href="#"><img src="{{ asset('frontend/img/home1/korea-flag.png') }}"
                                              alt="">Korean</a></li>
                                  <li><a href="#"><img src="{{ asset('frontend/img/home1/china-flag.png') }}"
                                              alt="">Chinese</a></li>
                              </ul>
                          </div>
                      ...
                      <div class="footer-widget">
                          ...
                          <ul class="widget-list">
                              ...
                              @foreach ($footerPolicyPages as $policyPage)
                                  <li><a
                                          href="{{ url('/policy/' . $policyPage->slug) }}">{{ $policyPage->title }}</a>
                                  </li>
                              @endforeach
          ...
          <div class="container">
              <div class="copyright-and-payment-method-area">
                  ...
                  <div class="payment-method-area">
                      ...
                      <ul>
                          <li><img src="{{ asset('frontend/img/home1/icon/mastar-card-icon.svg') }}" alt="">
                          </li>
