            ...
            <div class="footer-contact-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>Mail Us</span>
                            <a href="/cdn-cgi/l/email-protection#1871767e77587d60797568747d367b7775"><span class="__cf_email__" data-cfemail="aec7c0c8c1eecbd6cfc3dec2cb80cdc1c3">[email&#160;protected]</span></a>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
                        ...
                        <div class="footer-logo-and-addition-info">
                            ...
                            <div class="language-area">
                                ...
                                <ul class="language-list">
                                    <li><a href="#"><img src="{{ asset('frontend/img/home1/england-flag.png') }}" alt="">English</a></li>
                                    <li><a href="#"><img src="{{ asset('frontend/img/home1/netherlands-flag.png') }}" alt="">Dutch</a></li>
                                    <li><a href="#"><img src="{{ asset('frontend/img/home1/japan-flag.png') }}" alt="">Japanese</a></li>
                                    <li><a href="#"><img src="{{ asset('frontend/img/home1/korea-flag.png') }}" alt="">Korean</a></li>
                                    <li><a href="#"><img src="{{ asset('frontend/img/home1/china-flag.png') }}" alt="">Chinese</a></li>
                                </ul>
                            </div>
                            <a href="#"><img src="{{ asset('frontend/img/home1/icon/google-play.svg') }}" alt=""></a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="copyright-and-payment-method-area">
                    ...
                    <div class="payment-method-area">
                        ...
                        <ul>
                            <li><img src="{{ asset('frontend/img/home1/icon/mastar-card-icon.svg') }}" alt=""></li>
                            <li><img src="{{ asset('frontend/img/home1/icon/visa-icon.svg') }}" alt=""></li>
                            <li><img src="{{ asset('frontend/img/home1/icon/paypal-icon.svg') }}" alt=""></li>
                            <li><img src="{{ asset('frontend/img/home1/icon/gpay-icon.svg') }}" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
