...
@section('content')
    ...
    <div class="home2-package-slider-section mb-20">
                                    ...
                                    <div class="package-card">
                                        <div class="package-img-wrap">
                                            <a href="{{ route('rooms.show', $room->slug) }}" class="package-img">
                                                <img src="{{ $room->image ? asset($room->image) : asset('frontend/img/home2/houses/5.jpg') }}"
                                                    alt="{{ $room->name }}">
                                            </a>
        ...
        <div class="row mt-3 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="{{ route('rooms.index') }}" class="primary-btn1">
                    <span>
                        View All
                        <svg width="10" height="10" viewbox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="home2-package-slider-section mb-30">
        ...
        <div class="row mt-3 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="{{ route('houses.index') }}" class="primary-btn1">
                    <span>
                        View All
                        <svg width="10" height="10" viewbox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="home2-package-slider-section mb-30">
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p> Explore our collection of traditional boats, each offering a unique blend of cultural heritage
                            and modern comfort for an unforgettable maritime experience.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
        ...
        <div class="row mt-3 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex justify-content-center">
                <a href="{{ route('boats.index') }}" class="primary-btn1">
                    <span>
                        View All
                        <svg width="10" height="10" viewbox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path
