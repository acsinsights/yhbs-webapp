...
@section('content')
    ...
    <!-- Houses Sliding Section End-->

    <!--Boats Sliding Section Start-->
    <div class="home2-package-slider-section mb-30">
        <div class="container">
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h2>Traditional Boats</h2>
                        <p> Explore our collection of traditional boats, each offering a unique blend of cultural heritage and modern comfort for an unforgettable maritime experience.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
                                    ...
                                    <div class="package-card">
                                        <div class="package-img-wrap">
                                            <a href="{{ route('boats.show', $boat->slug) }}" class="package-img">
                                                <img src="{{ $boat->image ? asset($boat->image) : asset('frontend/img/home2/houses/5.jpg') }}"
                                                    alt="{{ $boat->name }}">
                                            </a>
                                        ...
                                        <div class="package-content">
                                            ...
                                            <div class="location-and-time">
                                                ...
                                                <span class="text-capitalize">{{ $boat->service_type }}</span>
                                            </div>
                                            <div class="btn-and-price-area">
                                                <a href="{{ route('houses.show', $house->slug) }}"
                                                    class="primary-btn1">
                                                ...
                                                <div class="price-area">
                                                    <h6>{{ $boat->min_passengers ?? 1 }} - {{ $boat->max_passengers ?? 10 }}
                                                    Passengers</h6>
                                                    <span>{{ currency_format($house->price_per_night) }}</span>
                                                </div>
                                            </div>
