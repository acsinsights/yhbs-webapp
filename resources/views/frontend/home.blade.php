                                ...
                                <div class="container">
                                    <div class="banner-content">
                                        ...
                                        @if ($slider->button_text && $slider->button_link)
                                            <a href="{{ $slider->button_link }}" class="primary-btn1 btn-hover">
                                                {{ $slider->button_text }}
                                            </a>
                                        @endif
                                    </div>
    ...
    <div class="filter-wrapper">
        <div class="container">
            <ul class="filter-item-list">
                ...
                <li class="single-item hotel" data-filter="rooms">
                    <svg width="24" height="24" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <li class="single-item visa" data-filter="boats">
                    <svg width="24" height="24" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <path
                        ...
                        <div class="custom-select-wrap">
                            ...
                            <ul class="option-list visa-list">
                                ...
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-india-flag.png') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-spain-flag.png') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
    ...
    <div class="home2-oneday-trip-section mb-100" style="margin-top: 100px">
        <div class="container">
            ...
            <div class="row g-4 mb-40">
                @forelse($rooms->take(1) as $room)
                    <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
                        <div class="package-card">
                            <div class="package-img-wrap">
                                @if ($room->library && $room->library->isNotEmpty())
                                    <div class="swiper package-card-img-slider">
                                        <div class="swiper-wrapper">
                                            @foreach ($room->library->take(3) as $image)
                                                <div class="swiper-slide">
                                                    <a href="{{ route('rooms.show', $room->slug) }}" class="package-img">
                            ...
                            <div class="package-content">
                                <h5><a href="{{ route('rooms.show', $room->slug) }}">{{ $room->name }}</a></h5>
                                <div class="location-and-time">
                                    <div class="location">
                                        ...
                                        <a href="{{ route('rooms.show', $room->slug) }}">Failaka Island, Kuwait</a>
                                    </div>
                                </div>
                                <div class="btn-and-price-area">
                                    ...
                                    <div class="price-area">
                                        <h6>Per Night</h6>
                                        <span>KD {{ number_format($room->price_per_night, 2) }}</span>
                                    </div>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="tooltip-text">{{ $room->adults }} Adults,
                                                    {{ $room->children }} Children</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                ...
                @forelse($houses->take(1) as $house)
                            ...
                            <div class="package-img-wrap">
                                <div class="swiper package-card-img-slider">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <a href="travel-package-details.html" class="package-img">
                                                <img src="{{ asset('frontend/img/home2/yatch/1 (1).jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Explore our featured boat collection for unforgettable maritime experiences.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
                <div class="col-lg-12">
                    <div class="swiper yacht-trip-slider">
                        <div class="swiper-wrapper">
                            @forelse($featuredBoats as $boat)
                                <div class="swiper-slide">
                                    <div class="package-card">
                                        <div class="package-img-wrap">
                                            <a href="{{ route('boats.show', $boat->slug) }}" class="package-img">
                                                <img src="{{ asset($boat->image) }}" alt="{{ $boat->name }}">
                                            </a>
                                            <div class="batch"><span>Featured</span></div>
                                        </div>
                                        <div class="package-content">
                                            <h5><a href="{{ route('boats.show', $boat->slug) }}">{{ $boat->name }}</a>
                                            </h5>
                                            <div class="location-and-time">
                                                <div class="location">
                                                    <svg width="14" height="14" viewbox="0 0 14 14"
                                                    ...
                                                    <a href="#">{{ $boat->location ?: 'Kuwait' }}</a>
                                                </div>
                                                <span>{{ $boat->service_type_label }}</span>
                                            </div>
                                            <div class="btn-and-price-area">
                                                <a href="{{ route('boats.show', $boat->slug) }}"
                                                    class="primary-btn1"><span>Book Now</span></a>
                                                <div class="price-area">
                                                    <h6>{{ $boat->max_passengers }} Guest</h6>
                                                    <span>{{ $boat->display_price }}</span>
                                                </div>
                                            </div>
                                            <svg class="divider" height="6" viewbox="0 0 374 6"
                                                xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="info">
                                                                ...
                                                                <div class="tooltip-text">
                                                                    {{ Str::limit(strip_tags($boat->description), 80) }}
                                                                </div>
                                                            </div>
                                                        </li>
                                                    @endif
                            ...
                            @empty
                                <div class="swiper-slide">
                                    <div class="text-center py-5">
                                        <p>No featured boats available at the moment.</p>
                                    </div>
                                </div>
                            @endforelse
                        </div>
            ...
            <div class="row g-4 mb-40">
                        ...
                        <div class="blog-card2">
                            <div class="blog-img-wrap">
                                ...
                                <a href="{{ route('blogs.show', $blog->slug) }}" class="blog-date">
                                    {{ $blog->date->format('d') }} <span>{{ $blog->date->format('M.') }}</span>
                                </a>
                            </div>
                ...
                @empty
                    <div class="col-12 text-center">
                        <p>No travel inspirations available at the moment.</p>
                    </div>
                @endforelse
            </div>
            <div class="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
