...
@section('content')
                                                ...
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Free WiFi</span><br />
                                                            <span>24/7 Room Service</span><br /> <span>LCD TV & Safe</span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Sea-facing
                                                                view</span><br /> <span>Premium bed</span><br /> <span>Ocean
                                                                view balcony</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16"
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Free WiFi</span><br />
                                                            <span>Pool & Spa access</span><br /> <span>Daily service</span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
    ...
    <div class="home2-package-slider-section mb-30">
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="swiper traditional-houses-slider">
                        <div class="swiper-wrapper">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <div class="tooltip-text">Including Activities <span>Scuba
                                                                    Diving,
                                                                    Zip-lining, Rafting & Rock Climbing</span> with this
                                                                premium
                                                                package.</div>
                                                        </div>
                                                    </li>
                            ...
                            @empty
                                <div class="swiper-slide">
                                    <div class="package-card text-center p-5">
                                        <p class="text-muted">No houses available at the moment.</p>
                                    </div>
                                </div>
                            @endforelse
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="swiper-pagination2 house-pagination paginations"></div>
                </div>
            </div>
        </div>
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector1.svg') }}" alt=""
