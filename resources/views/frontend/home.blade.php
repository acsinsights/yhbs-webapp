                ...
                <div class="swiper-slide">
                    <div class="banner-wrapper">
                        <div class="banner-img-area">
                            <img src="{{ asset('frontend/img/home2/banner-img1.jpg') }}" alt="Comfortable Rooms">
                        </div>
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
                                ...
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/tour-package-img1.jpg') }}"
                                                alt="">
                                        </a>
                                        <div class="batch">
                                            <span>Sale on!</span>
    ...
    <div class="home2-about-section mb-100">
        <div class="container">
            ...
            <div class="service-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div
                    class="row row-cols-xl-6 row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1 g-xxl-4 g-xl-3 g-lg-3 g-4">
                    <div class="col">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="tooltip-text">Includes: <span>Private bedroom</span><br />
