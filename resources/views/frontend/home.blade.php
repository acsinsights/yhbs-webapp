...
@section('content')
        ...
        <div class="swiper home2-banner-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-wrapper">
                        <div class="banner-video-area">
                            <img src="{{ asset('frontend/img/innerpages/background/luxurious-villa-with-modern-architectural-design (1).jpg') }}"
                                alt="Island House">
                        </div>
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
                                    <h1>Your Island House, Your Comfort.</h1>
                                    <p>Experience peaceful stays in traditional and modern island houses designed for
                ...
                <div class="swiper-slide">
                    <div class="banner-wrapper">
                        <div class="banner-img-area">
                            <img src="{{ asset('frontend/img/innerpages/background//3d-rendering-beautiful-comtemporary-luxury-bedroom-suite-hotel-with-tv (1).jpg') }}"
                                alt="Comfortable Rooms">
                        </div>
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
                                    <h2>Comfortable Rooms for Every Traveler.</h2>
                                    <p>Enjoy cozy, fully furnished rooms with beach access and the simplicity of island
                                        living.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="banner-wrapper">
                        <div class="banner-img-area">
                            <img src="{{ asset('frontend/img/home2/banner-img2.jpg') }}" alt="">
                        </div>
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
                                    <h2>Sail the Gulf in Luxury.</h2>
                                    <p>Book private yachts for family trips, celebrations, and unforgettable sea adventures.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="filter-input-wrap">
                        ...
                        <div class="custom-select-dropdown destination-dropdown">
                            ...
                            <div class="input-field-value">
                                <div class="destination">
                                    <h6>Heritage House – 2 Bedroom</h6>
                                </div>
                            </div>
                        </div>
                        <div class="custom-select-wrap">
                            ...
                            <ul class="option-list-destination">
                                <li>
                                    <div class="destination">
                                        <h6>Heritage House – 2 Bedroom</h6>
                                        <span>Failaka Island, Kuwait</span>
                                    </div>
                                    <div class="tour">
                                        <span>$89</span>
                                    </div>
                                ...
                                <li>
                                    <div class="destination">
                                        <h6>Heritage House – 3 Bedroom</h6>
                                        <span>Failaka Island, Kuwait</span>
                                    </div>
                                    <div class="tour">
                                        <span>$119</span>
                                ...
                                <li>
                                    <div class="destination">
                                        <h6>Traditional Island House</h6>
                                        <span>Failaka Island, Kuwait</span>
                                    </div>
                                    <div class="tour">
                                        <span>$79</span>
                                ...
                                <li>
                                    <div class="destination">
                                        <h6>Group Stay House (6–10 Persons) </h6>
                                        <span>Failaka Island, Kuwait</span>
                                    </div>
                                    <div class="tour">
                                        <span>$159</span>
                ...
                <form class="filter-input two">
                    <div class="single-search-box">
                        ...
                        <div class="custom-select-dropdown destination-dropdown">
                            ...
                            <div class="input-field-value">
                                <div class="destination">
                                    <h6>Standard Room – Single Bed</h6>
                                    <span>Failaka Island, Kuwait</span>
                                </div>
                            </div>
                        </div>
                        <div class="custom-select-wrap three">
                            ...
                            <ul class="option-list-destination">
                                ...
                                <li>
                                    <div class="destination">
                                        <h6>Standard Room – Double Bed</h6>
                                        <span>Failaka Island, Kuwait</span>
                                    </div>
                                    <div class="tour">
                                        <span>$39</span>
                ...
                <form class="filter-input two">
                    <div class="single-search-box">
                        ...
                        <div class="custom-select-dropdown destination-dropdown">
                            ...
                            <div class="input-field-value">
                                <div class="destination">
                                    <h6>Limousine VIP</h6>
                                    <span>Marina Waves, Kuwait City</span>
                                </div>
                            </div>
                        </div>
                        <div class="custom-select-wrap three">
                            ...
                            <ul class="option-list-destination">
                                ...
                                <li>
                                    <div class="destination">
                                        <h6>Passenger Boat</h6>
                                        <span>Kuwait Gulf Waters</span>
                                    </div>
                                    <div class="tour">
                                        <span>$129</span>
                                    </div>
                    ...
                    <div class="single-search-box date-field">
                        ...
                        <div class="custom-select-dropdown">
                            <input type="text" name="daterange" class="yacht-checkin" readonly=""
                                value="June 16 - June 20">
                            <div class="yacht-selected-date-checkin"></div>
                        </div>
                    </div>
                    <div class="single-search-box date-field">
                        <svg width="18" height="18" viewbox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="custom-select-dropdown">
                            <input type="text" name="daterange" class="yacht-checkin" readonly=""
                                value="June 16 - June 20">
                            <div class="yacht-selected-date-checkout"></div>
                        </div>
                    </div>
                    <button type="submit" class="primary-btn1">
                        <span>
                        ...
                        <div class="custom-select-wrap">
                            ...
                            <ul class="option-list visa-list">
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-bd-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-indo-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-nepal-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-india-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-brazil-flag.png') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-thailand-flag.png') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-spain-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-uae-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-usa-flag.png') }}" alt="">
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row g-4 mb-40">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="package-card">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/3.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="package-content">
                            <h5><a href="travel-package-details.html">Standard Island Room</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    ...
                                    <a href="travel-package-01.html">Failaka Island, Kuwait</a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="package-card">
                        ...
                        <div class="package-content">
                            <h5><a href="travel-package-details.html">Traditional Heritage House</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewbox="0 0 14 14"
                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="travel-package-01.html">Heritage Village, Failaka
                                    </a>
                                </div>
                            </div>
                            <div class="btn-and-price-area">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="tooltip-text">Includes: <span>Family-style house</span></br>
                                                <span>Outdoor sitting area</span> <span>Cultural village access</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/8.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/2 (1).jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/1 (2).jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/1 (1).jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="package-content">
                            <h5><a href="travel-package-details.html">Private Yacht Cruise (2 Hours)</a></h5>
                            <div class="location-and-time">
                                <div class="location">
                                    <svg width="14" height="14" viewbox="0 0 14 14"
                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="travel-package-01.html">Marina Crescent, Kuwait City</a>
                                </div>
                            </div>
                            <div class="btn-and-price-area">
                                <a href="travel-package-details.html" class="primary-btn1">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="tooltip-text">Includes: <span>Captain & crew</span></br>
                                                <span>Refreshments</span></span></br><span>Photo stops</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
            ...
            <div class="service-wrapper two">
                <div class="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms"
                    ...
                    <div class="col-lg-9">
                        <div class="section-title">
                            <h2>IKARUS – Your Sea Journey, Our Responsibility!</h2>
                ...
                <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <li class="single-service">
                        ...
                        <div class="content">
                            <h4>One-Click Marine Booking</h4>
                            <p>"Book yachts, island trips, and marine services instantly with our seamless booking
                                experience."</p>
                        </div>
                    </li>
                    <li class="single-service">
                        ...
                        <div class="content">
                            <h4>Exclusive Deals & Packages</h4>
                            <p>"Enjoy budget-friendly packages on cruises, yachts, and island tours with exclusive seasonal
                                discounts."</p>
                        </div>
                    </li>
                    <li class="single-service">
                        ...
                        <div class="content">
                            <h4>Expert Marine Assistance</h4>
                            <p>"Certified marine professionals provide assistance, ensuring your trip is safe, smooth, and
                                enjoyable."</p>
                        </div>
                    </li>
                </ul>
    ...
    <div class="home2-destination-section mb-100">
        <div class="container">
            <div class="section-title text-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                data-wow-duration="1500ms">
    ...
    <div class="home2-about-section mb-100">
        <div class="container">
            <div class="row mb-60">
                <div class="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="about-content">
                        <div class="section-title">
                            <h2>Your Trusted Partner for Marine Adventures.</h2>
                            <p><span>At IKARUS Marine Services, we deliver safe, comfortable, and memorable sea journeys.
                                    From yacht rentals to island trips and heritage tours, we ensure every experience is
                                    smooth and enjoyable — whether it’s for families, groups, or corporate travel.</p>
                        </div>
                        <div class="counter-area">
                            ...
                            <div class="single-counter">
                                <h2><strong class="counter">15</strong><sup>+</sup></h2>
                                <span>Years <br> of Experience</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-lg-block d-none wow animate fadeInRight" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                    <div class="about-img-wrap">
                        <div class="row align-items-end g-xl-4 g-lg-2 g-4">
                            <div class="col-lg-6">
                                <div class="single-img">
                                    <img src="{{ asset('frontend/img/home2/about-img1.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="single-img">
                                    <img src="{{ asset('frontend/img/home2/about-img2.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="logo">
                            <img src="{{ asset('frontend/img/home2/icon/trip-advisor-icon.svg') }}" alt="">
                        </div>
                        <svg class="vector" width="173" height="136" viewbox="0 0 173 136"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div class="service-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div
                    class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-2 row-cols-sm-1 row-cols-1 g-xxl-4 g-xl-4 g-lg-4 g-4">
                    <div class="col">
                        ...
                        <div class="single-service">
                            <a href="destination-01.html">
                                <svg width="30" height="30" viewbox="0 0 30 30"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M27.5758 14.3906L26.4082 10.8281C26.2656 10.4375 25.8945 10.2188 25.5039 10.2188H23.5703L20.8125 4.375C20.625 3.98438 20.2539 3.80469 19.8359 3.80469H10.2148C9.79688 3.80469 9.42578 3.98438 9.23828 4.375L6.48047 10.2188H4.54688C4.15625 10.2188 3.78516 10.4375 3.64258 10.8281L2.47109 14.3906C2.29297 14.9141 2.51172 15.4844 3.04688 15.6797L3.38281 26.6172C3.42969 27.832 4.45703 28.8047 5.67578 28.8047H24.3949C25.6137 28.8047 26.6176 27.832 26.6645 26.6172L27.9648 15.6797C28.4648 15.4844 28.6836 14.9141 28.5758 14.3906H27.5758ZM10.8594 5.66406H19.1758L21.4277 10.2188H8.64453L10.8594 5.66406ZM9.02344 18.2344C8.70703 18.2344 8.45313 17.9805 8.45313 17.6641C8.45313 17.3477 8.70703 17.0938 9.02344 17.0938C9.33984 17.0938 9.59375 17.3477 9.59375 17.6641C9.59375 17.9805 9.33984 18.2344 9.02344 18.2344ZM15 18.2344C14.6836 18.2344 14.4297 17.9805 14.4297 17.6641C14.4297 17.3477 14.6836 17.0938 15 17.0938C15.3164 17.0938 15.5703 17.3477 15.5703 17.6641C15.5703 17.9805 15.3164 18.2344 15 18.2344ZM20.9766 18.2344C20.6602 18.2344 20.4063 17.9805 20.4063 17.6641C20.4063 17.3477 20.6602 17.0938 20.9766 17.0938C21.293 17.0938 21.5469 17.3477 21.5469 17.6641C21.5469 17.9805 21.293 18.2344 20.9766 18.2344Z">
                                    </path>
                                </svg>
                                Luxury Yachts
                            </a>
    ...
    <div class="home2-package-slider-section mb-20">
        <div class="container">
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h2>Rooms</h2>
                        <p>Browse our collection of comfortable and affordable rooms for your stay.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
                <div class="col-lg-12">
                    <div class="swiper rooms-trip-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/1.jpg') }}"
                                                alt="">
                                        </a>
                                        <div class="batch"><span>Featured</span></div>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">Double Room</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="#">Failaka Island, Kuwait</a>
                                            </div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area">
                                            <a href="#" class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>2 Guests</h6><span>KD 60</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        <svg width="12" height="12" viewbox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                            <g><path d="M6 0.375C4.88748 0.375 3.79995 0.704901 2.87492 1.32298C1.94989 1.94107 1.22892 2.81957 0.80318 3.84741C0.377437 4.87524 0.266043 6.00624 0.483085 7.09738C0.700127 8.18853 1.23586 9.19081 2.02253 9.97748C2.8092 10.7641 3.81148 11.2999 4.90262 11.5169C5.99376 11.734 7.12476 11.6226 8.1526 11.1968C9.18043 10.7711 10.0589 10.0501 10.677 9.12508C11.2951 8.20006 11.625 7.11252 11.625 6C11.6245 4.50831 11.0317 3.07786 9.97693 2.02307C8.92215 0.968289 7.49169 0.375497 6 0.375ZM6 9.375C5.85167 9.375 5.70666 9.33101 5.58333 9.2486C5.45999 9.16619 5.36386 9.04906 5.30709 8.91201C5.25033 8.77497 5.23548 8.62417 5.26441 8.47868C5.29335 8.3332 5.36478 8.19956 5.46967 8.09467C5.57456 7.98978 5.7082 7.91835 5.85369 7.88941C5.99917 7.86047 6.14997 7.87533 6.28702 7.93209C6.42406 7.98886 6.54119 8.08499 6.62361 8.20832C6.70602 8.33166 6.75 8.47666 6.75 8.625C6.74941 8.82373 6.6702 9.01415 6.52968 9.15468C6.38915 9.2952 6.19873 9.37441 6 9.375ZM6.85875 3.55875L6.6075 6.56625C6.5944 6.71834 6.52472 6.85999 6.41224 6.9632C6.29976 7.0664 6.15266 7.12367 6 7.12367C5.84735 7.12367 5.70024 7.0664 5.58776 6.9632C5.47528 6.85999 5.40561 6.71834 5.3925 6.56625L5.14125 3.55875C5.13042 3.44226 5.1434 3.32478 5.1794 3.21346C5.2154 3.10214 5.27367 2.99931 5.35067 2.91123C5.42767 2.82314 5.52178 2.75165 5.62729 2.70108C5.73279 2.65052 5.84748 2.62195 5.96437 2.61711C6.08127 2.61227 6.19793 2.63126 6.30725 2.67294C6.41657 2.71461 6.51627 2.77808 6.60029 2.8595C6.6843 2.94092 6.75087 3.03858 6.79595 3.14655C6.84103 3.25451 6.86367 3.37051 6.8625 3.4875C6.86313 3.51131 6.86187 3.53514 6.85875 3.55875Z"></path></g>
                                                        </svg>
                                                        <div class="tooltip-text">Includes: <span>Comfortable bed</span><br/> <span>Private bathroom</span><br/> <span>Air-conditioning</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                        <g><path d="M8 0C3.58853 0 0 3.58853 0 8C0 12.4115 3.58853 16 8 16C12.4115 16 16 12.4108 16 8C16 3.58916 12.4115 0 8 0ZM8 14.7607C4.27266 14.7607 1.23934 11.728 1.23934 8C1.23934 4.27203 4.27266 1.23934 8 1.23934C11.7273 1.23934 14.7607 4.27203 14.7607 8C14.7607 11.728 11.728 14.7607 8 14.7607Z"></path><path d="M11.0984 7.32445H8.6197V4.84576C8.6197 4.5037 8.3427 4.22607 8.00001 4.22607C7.65733 4.22607 7.38033 4.5037 7.38033 4.84576V7.32445H4.90164C4.55895 7.32445 4.28195 7.60207 4.28195 7.94414C4.28195 8.2862 4.55895 8.56382 4.90164 8.56382H7.38033V11.0425C7.38033 11.3846 7.65733 11.6622 8.00001 11.6622C8.3427 11.6622 8.6197 11.3846 8.6197 11.0425V8.56382H11.0984C11.4411 8.56382 11.7181 8.2862 11.7181 7.94414C11.7181 7.60207 11.4411 7.32445 11.0984 7.32445Z"></path></g>
                                                    </svg>
                                                    Inclusion
                                                    <div class="info">
                                                        <svg width="12" height="12" viewbox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Free WiFi</span><br/> <span>24/7 Room Service</span><br/> <span>LCD TV & Safe</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="#">Sea View Room</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Failaka Island, Kuwait</a></div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area"><a href="#"
                                                class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>2 Guests</h6><span>KD 70</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM369 3.5L374 5.88675V0.113249L369 2.5V3.5ZM4.5 3.5H369.5V2.5H4.5V3.5Z"></path>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Sea-facing view</span><br/> <span>Premium bed</span><br/> <span>Ocean view balcony</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Free WiFi</span><br/> <span>Telescope provided</span><br/> <span>Premium toiletries</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/3.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Spacious bedroom</span><br/> <span>Separate living area</span><br/> <span>Luxury bathroom</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Bathrobes & slippers</span><br/> <span>Jetted tub</span><br/> <span>Complimentary breakfast</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/hotel roms/4.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="#">Pool View Room</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Failaka Island, Kuwait</a></div>
                                            <span>Per Night</span>
                                        </div>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Pool view balcony</span><br/> <span>Modern amenities</span><br/> <span>Comfortable seating</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Free WiFi</span><br/> <span>Pool & Spa access</span><br/> <span>Daily service</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img3.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="#">Deluxe Sea View Suite</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Failaka Island, Kuwait</a></div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area"><a href="#"
                                                class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>2 Guest</h6><span>KD 110</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM369 3.5L374 5.88675V0.113249L369 2.5V3.5ZM4.5 3.5H369.5V2.5H4.5V3.5Z"></path>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Panoramic sea views</span><br/> <span>Deluxe furnishings</span><br/> <span>Premium suite</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Concierge service</span><br/> <span>Premium spa</span><br/> <span>Gourmet dining</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="swiper-pagination2 rooms-pagination paginations"></div>
                </div>
            </div>
        </div>
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector1.svg') }}" alt=""
            class="vector1">
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector2.svg') }}" alt=""
            class="vector2">
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector3.svg') }}" alt=""
            class="vector3">
    </div>
    <!-- Rooms Sliding Section End-->

    <!-- home2 one day trip Section Start-->
    <div class="home2-package-slider-section mb-30" >
        <div class="container">
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h2>Traditional Houses</h2>
                        <p>A curated selection of our authentic Kuwaiti-style heritage houses designed for family stays and
                            group getaways.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
                <div class="col-lg-12">
                    <div class="swiper traditional-houses-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                    ...
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">Two-Room House</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">This package covers <span>Accommodation,
                                                                Daily Meals, Entry Fees & Local Transfers</span> to ensure a
                                                            worry-free trip.</div>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <div class="swiper package-card-img-slider">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('frontend/img/home1/tour-package-img2.jpg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('frontend/img/home1/tour-package-img10.jpg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('frontend/img/home1/tour-package-img11.jpg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">Three-Room House</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="travel-package-01.html">Marina Waves, Kuwait City</a>
                                            </div>
                                            <svg class="arrow" width="25" height="6" viewbox="0 0 25 6"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/tour-package-img2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">Four-Room House</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img6.jpg') }}"
                                                alt="">
                                        </a>
                                        <div class="batch">
                                            <span>Hot Sale!</span>
                                    ...
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">Five-Room House</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="travel-package-01.html">Kuwait Gulf Waters</a>
                                            </div>
                                            <svg class="arrow" width="25" height="6" viewbox="0 0 25 6"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img4.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">(Big) House</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="swiper-pagination2 traditional-houses-pagination paginations"></div>
                </div>
            </div>
        </div>
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector1.svg') }}" alt=""
        ...
        <div class="container">
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h2>Yachts</h2>
                        <p>Explore our luxury yacht collection for unforgettable maritime experiences.</p>
                    </div>
                </div>
            </div>
            <div class="row mb-40">
                <div class="col-lg-12">
                    <div class="swiper yacht-trip-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                    ...
                                    <div class="package-content">
                                        <h5><a href="travel-package-details.html">Yachts</a></h5>
                                        <div class="location-and-time">
                                            <div class="location">
                                                <svg width="14" height="14" viewbox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Professional captain</span><br/> <span>Safety equipment</span><br/> <span>Navigation systems</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Fuel included</span><br/> <span>Insurance covered</span><br/> <span>Mooring facilities</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/2 (1).jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="#">Limousine</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Luxury Sea Limousine</a></div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area"><a href="#"
                                                class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>4 Guest</h6><span>KD 119</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM369 3.5L374 5.88675V0.113249L369 2.5V3.5ZM4.5 3.5H369.5V2.5H4.5V3.5Z"></path>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Luxury cabin</span><br/> <span>Crew on board</span><br/> <span>Premium service</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Fuel included</span><br/> <span>Insurance covered</span><br/> <span>VIP service</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/yatch/1 (2).jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                                        <h5><a href="#">Land Craft</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Cargo & Utility Craft</a></div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area"><a href="#"
                                                class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>2 Guest</h6><span>KD 79</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM369 3.5L374 5.88675V0.113249L369 2.5V3.5ZM4.5 3.5H369.5V2.5H4.5V3.5Z"></path>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Sturdy hull design</span><br/> <span>Cargo capacity</span><br/> <span>Utility features</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Fuel included</span><br/> <span>Loading equipment</span><br/> <span>Safety systems</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    ...
                                    <div class="package-content">
                                        <h5><a href="#">Catamaran</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Twin-Hull Leisure Boat</a></div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area"><a href="#"
                                                class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>6 Guest</h6><span>KD 99</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM369 3.5L374 5.88675V0.113249L369 2.5V3.5ZM4.5 3.5H369.5V2.5H4.5V3.5Z"></path>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Twin-hull design</span><br/> <span>Spacious deck</span><br/> <span>Stable sailing</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Amenities: <span>Fuel included</span><br/> <span>Crew assistance</span><br/> <span>Comfort cabin</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    ...
                                    <div class="package-content">
                                        <h5><a href="#">Passenger Boats</a></h5>
                                        <div class="location-and-time">
                                            <div class="location"><a href="#">Fast Passenger Ferries</a></div>
                                            <span>Per Night</span>
                                        </div>
                                        <div class="btn-and-price-area"><a href="#"
                                                class="primary-btn1"><span>Book Now</span></a>
                                            <div class="price-area">
                                                <h6>8 Guest</h6><span>KD 129</span>
                                            </div>
                                        </div>
                                        <svg class="divider" height="6" viewbox="0 0 374 6" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 2.5L0 0.113249V5.88675L5 3.5V2.5ZM369 3.5L374 5.88675V0.113249L369 2.5V3.5ZM4.5 3.5H369.5V2.5H4.5V3.5Z"></path>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="tooltip-text">Includes: <span>Fast cruising</span><br/> <span>Comfortable seating</span><br/> <span>Modern facilities</span></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <svg width="16" height="16" viewbox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div class="info">
                                                        <svg width="12" height="12" viewbox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                            <g><path d="M6 0.375C4.88748 0.375 3.79995 0.704901 2.87492 1.32298C1.94989 1.44107 1.22892 2.81957 0.80318 3.84741C0.377437 4.87524 0.266043 6.00624 0.483085 7.09738C0.700127 8.18853 1.23586 9.19081 2.02253 9.97748C2.8092 10.7641 3.81148 11.2999 4.90262 11.5169C5.99376 11.734 7.12476 11.6226 8.1526 11.1968C9.18043 10.7711 10.0589 10.0501 10.677 9.12508C11.2951 8.20006 11.625 7.11252 11.625 6C11.6245 4.50831 11.0317 3.07786 9.97693 2.02307C8.92215 0.968289 7.49169 0.375497 6 0.375ZM6 9.375C5.85167 9.375 5.70666 9.33101 5.58333 9.2486C5.45999 9.16619 5.36386 9.04906 5.30709 8.91201C5.25033 8.77497 5.23548 8.62417 5.26441 8.47868C5.29335 8.3332 5.36478 8.19956 5.46967 8.09467C5.57456 7.98978 5.7082 7.91835 5.85369 7.88941C5.99917 7.86047 6.14997 7.87533 6.28702 7.93209C6.42406 7.98886 6.54119 8.08499 6.62361 8.20832C6.70602 8.33166 6.75 8.47666 6.75 8.625C6.74941 8.82373 6.6702 9.01415 6.52968 9.15468C6.38915 9.2952 6.19873 9.37441 6 9.375ZM6.85875 3.55875L6.6075 6.56625C6.5944 6.71834 6.52472 6.85999 6.41224 6.9632C6.29976 7.0664 6.15266 7.12367 6 7.12367C5.84735 7.12367 5.70024 7.0664 5.58776 6.9632C5.47528 6.85999 5.40561 6.71834 5.3925 6.56625L5.14125 3.55875C5.13042 3.44226 5.1434 3.32478 5.1794 3.21346C5.2154 3.10214 5.27367 2.99931 5.35067 2.91123C5.42767 2.82314 5.52178 2.75165 5.62729 2.70108C5.73279 2.65052 5.84748 2.62195 5.96437 2.61711C6.08127 2.61227 6.19793 2.63126 6.30725 2.67294C6.41657 2.71461 6.51627 2.77808 6.60029 2.8595C6.6843 2.94092 6.75087 3.03858 6.79595 3.14655C6.84103 3.25451 6.86367 3.37051 6.8625 3.4875C6.86313 3.51131 6.86187 3.53514 6.85875 3.55875Z"></path></g>
                                                        </svg>
                                                        <div class="tooltip-text">Amenities: <span>Fuel included</span><br/> <span>Onboard dining</span><br/> <span>Restrooms</span></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="swiper-pagination2 yacht-pagination paginations"></div>
                </div>
            </div>
        </div>
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector1.svg') }}" alt=""
    ...
    <!-- Yacht Sliding Section End-->

    <!-- home2 offer banner Section Start-->
    <div class="home2-offer-banner-section mb-100" style="padding-top:50px;">
        <div class="container">
            <div class="offer-banner-wrap">
                <div class="offer-banner-content wow animate fadeInLeft" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                ...
                <div class="offer-banner-img">
                    <img src="{{ asset('frontend/img/home2/home2-offer-banner-img.png') }}" alt="">
                </div>
                <img src="{{ asset('frontend/img/home2/vector/offer-banner-vector1.svg') }}" alt=""
                    class="vector1">
                <img src="{{ asset('frontend/img/home2/vector/offer-banner-vector2.svg') }}" alt=""
                    class="vector2">
            </div>
        </div>
            ...
            <div class="row gy-md-5 gy-4">
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img7.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img17.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img18.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms"
                    ...
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('frontend/img/home1/tour-package-img8.jpg') }}" alt="">
                            </a>
                            <div class="batch">
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms"
                    ...
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('frontend/img/home1/tour-package-img9.jpg') }}" alt="">
                            </a>
                            <div class="batch">
        ...
        <div class="container">
            <div class="banner-content">
                <div class="award-rating-area">
                    <img src="{{ asset('frontend/img/home2/travel-award.png') }}" alt="">
            ...
            <div class="partner-wrap">
                <div class="marquee">
                    <div class="marquee__group">
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-01.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-02.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-03.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-04.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-05.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-06.png') }}"
                                alt=""></a>
                    </div>
            ...
            <div class="row g-4 mb-40">
                    ...
                    <div class="blog-card2">
                        <div class="blog-img-wrap">
                            <a href="travel-inspiration-details.html" class="blog-img">
                                <img src="{{ asset('frontend/img/home2/blog-img1.jpg') }}" alt="">
                            </a>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms"
                    ...
                    <div class="blog-card2">
                        <div class="blog-img-wrap">
                            <a href="travel-inspiration-details.html" class="blog-img">
                                <img src="{{ asset('frontend/img/home2/blog-img2.jpg') }}" alt="">
                            </a>
                            <a href="travel-inspiration-01.html" class="blog-date">
                                04 <span>Feb.</span>
                            </a>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms"
                    ...
                    <div class="blog-card2">
                        <div class="blog-img-wrap">
                            <a href="travel-inspiration-details.html" class="blog-img">
                                <img src="{{ asset('frontend/img/home2/blog-img3.jpg') }}" alt="">
                            </a>
                            <a href="travel-inspiration-01.html" class="blog-date">
                                07 <span>Feb.</span>
                            </a>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img3.png') }}"
                                                alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>James Bonde</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img2.png') }}"
                                                alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>Selina Henry</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img4.png') }}"
                                                alt="">
                                        </div>
                                        <div class="author-info">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img5.png') }}"
                                                alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>Amber Lashley</h5>
            ...
            <div class="review-and-slider-btn wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <a href="https://www.trustpilot.com/" class="single-rating">
                    ...
                    <div class="trustpilot-rating">
                        <img src="{{ asset('frontend/img/home1/icon/trustpilot-logo.svg') }}" alt="">
                        <div class="rating-area">
                            <img src="{{ asset('frontend/img/home1/icon/trustpilot-star.svg') }}" alt="">
                ...
                <a href="https://www.tripadvisor.com/" class="single-rating">
                    ...
                    <div class="tripadvisor-rating">
                        <img src="{{ asset('frontend/img/home1/icon/tripadvisor-logo.svg') }}" alt="">
                        <div class="rating-area">
                            <span>Reviews</span>
                            <img src="{{ asset('frontend/img/home1/icon/tripadvisor-start.svg') }}" alt="">
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="container">
            <div class="row gy-md-5 gy-4 align-items-stretch justify-content-between">
                <div class="col-lg-3 col-sm-6 divider d-flex justify-content-lg-center">
                    ...
                    <svg class="line" width="6" height="215" viewbox="0 0 6 215"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            <div class="col-md-7 mt-70">
                                <div class="single-img justify-content-md-end">
                                    <a data-fancybox="gallery-01"
                                        href="{{ asset('frontend/img/home2/gallery-img1-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img1.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="single-img justify-content-md-end">
                                    <a data-fancybox="gallery-01"
                                        href="{{ asset('frontend/img/home2/gallery-img2-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="single-img justify-content-md-between">
                                    ...
                                    <a data-fancybox="gallery-01"
                                        href="{{ asset('frontend/img/home2/gallery-img3-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img3.jpg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="single-img grp-img">
                                    <a data-fancybox="gallery-01"
                                        href="{{ asset('frontend/img/home2/gallery-img4-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img4.jpg') }}" alt="">
                                    </a>
                                    <a data-fancybox="gallery-01"
                                        href="{{ asset('frontend/img/home2/gallery-img5-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img5.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="single-img">
                                    <a data-fancybox="gallery-01"
                                        href="{{ asset('frontend/img/home2/gallery-img6-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img6.jpg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
