...
@section('content')
  ...
  <!-- home2 Banner Section Start-->
    <div class="home2-banner-section">
                ...
                <div class="swiper-slide">
                    <div class="banner-wrapper">
                        <div class="banner-video-area">
                            <video autoplay="" loop="" muted="" playsinline="" src="{{ asset('frontend/video/home2-banner-video.mp4') }}"></video>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="banner-wrapper">
                        <div class="banner-img-area">
                            <img src="{{ asset('frontend/img/home2/banner-img1.jpg') }}" alt="">
                        </div>
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
        ...
        <div class="slider-btn-grp">
            <div class="slider-btn banner-slider-prev">
                <svg width="22" height="22" viewbox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.942857 11.9429C5.3768 11.9429 9.00115 8.0432 9.00115 3.88457V2.94171H7.11543V3.88457C7.11543 7.04251 4.29566 10.0571 0.942857 10.0571H0V11.9429H0.942857Z"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.942857 10.0571C5.3768 10.0571 9.00115 13.9568 9.00115 18.1154V19.0583H7.11543V18.1154C7.11543 14.9587 4.29566 11.9428 0.942857 11.9428H0V10.0571H0.942857Z"></path>
                    </g>
                </svg>
            </div>
            <div class="slider-btn banner-slider-next">
                <svg width="22" height="22" viewbox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M22 10.0571H-5.72205e-06V11.9428H22V10.0571Z"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M21.0571 11.9429C16.6232 11.9429 12.9989 8.0432 12.9989 3.88457V2.94171H14.8846V3.88457C14.8846 7.04251 17.7043 10.0571 21.0571 10.0571H22V11.9429H21.0571Z"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M21.0571 10.0571C16.6232 10.0571 12.9989 13.9568 12.9989 18.1154V19.0583H14.8846V18.1154C14.8846 14.9587 17.7043 11.9428 21.0571 11.9428H22V10.0571H21.0571Z"></path>
                    </g>
                </svg>
            </div>
        </div>
            ...
            <div class="filter-input-wrap">
                ...
                <form class="filter-input two">
                        ...
                        <div class="custom-select-wrap">
                            ...
                            <ul class="option-list visa-list">
                                ...
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-brazil-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('frontend/img/home1/filter-thailand-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                    ...
                    <div class="single-search-box">
                        <svg width="20" height="20" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <path d="M15.3998 7.57539L7.58413 3.92737L-0.232422 7.57539L-0.0544699 7.95176L7.54053 4.40428C7.55525 4.39725 7.57137 4.3936 7.58769 4.3936C7.604 4.3936 7.62012 4.39725 7.63484 4.40428L15.2263 7.95354L15.3998 7.57539Z"></path>
                                <path d="M0.666504 7.85924V9.86476L7.53724 6.65539C7.55208 6.64876 7.56814 6.64534 7.58439 6.64534C7.60065 6.64534 7.61671 6.64876 7.63155 6.65539L14.5023 9.86476V7.85924L7.58439 4.62762L0.666504 7.85924Z"></path>
                                <path d="M15.3998 10.5339L14.5661 10.1451L7.58413 6.88324L0.602174 10.1407L-0.232422 10.5339L-0.0544699 10.9112L7.54053 7.36282C7.55537 7.3562 7.57144 7.35277 7.58769 7.35277C7.60394 7.35277 7.62001 7.3562 7.63484 7.36282L15.2298 10.9112L15.3998 10.5339ZM1.67078 13.2966H4.93086V20.0001H1.67078V13.2966Z"></path>
                                <path d="M7.6957 1.10241V3.73166L15.595 7.41972C15.6216 7.43226 15.6422 7.45484 15.6522 7.48253C15.6622 7.51022 15.6608 7.54074 15.6484 7.56741L15.3815 8.14487C15.3755 8.15812 15.3669 8.17002 15.3562 8.17982C15.3455 8.18961 15.3329 8.1971 15.3192 8.20181C15.2906 8.21294 15.2588 8.21294 15.2302 8.20181L14.7212 7.96425V9.96888L15.5914 10.3755C15.6181 10.388 15.6386 10.4106 15.6487 10.4383C15.6587 10.466 15.6573 10.4965 15.6448 10.5232L15.3779 11.1015C15.372 11.1149 15.3634 11.1269 15.3527 11.1369C15.342 11.1468 15.3294 11.1545 15.3156 11.1594C15.3015 11.1653 15.2864 11.1684 15.2711 11.1684C15.2558 11.1684 15.2407 11.1653 15.2266 11.1594L14.7177 10.9218V20H18.5881V6.18829L10.873 2.58564L7.6957 1.10241ZM6.83797 0L6.66357 0.376369L9.29104 1.60157L18.7536 6.01478L18.7554 6.01834L20.058 6.62605L20.2324 6.24968L6.83797 0Z"></path>
                                <path d="M10.502 12.6124H11.906V14.0155H10.502V12.6124ZM10.502 14.3287H11.906V15.7319H10.502V14.3287ZM12.2014 12.6124H13.6054V14.0155H12.2014V12.6124ZM12.2014 14.3287H13.6054V15.7319H12.2014V14.3287Z"></path>
                                <path d="M7.69535 20.0001H14.502V10.8133L7.69535 7.63416V20.0001ZM8.14023 8.33262L14.0571 11.0962V19.5552H8.14023V8.33262ZM0.666244 20.0001H1.44834V13.1854C1.44834 13.1559 1.46006 13.1276 1.48092 13.1067C1.50178 13.0859 1.53007 13.0742 1.55956 13.0742H5.04209C5.07159 13.0742 5.09987 13.0859 5.12073 13.1067C5.14159 13.1276 5.15331 13.1559 5.15331 13.1854V20.0001H7.42576V7.6564L0.663574 10.8133L0.666244 20.0001Z"></path>
                            </g>
                        </svg>
                        <div class="custom-select-dropdown">
    ...
    <div class="home2-package-slider-section mb-100">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/tour-package-img1.jpg') }}" alt="">
                                        </a>
                                        <div class="batch">
                                            <span>Sale on!</span>
                                        </div>
                                    ...
                                    <div class="package-img-wrap">
                                        <div class="swiper package-card-img-slider">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('frontend/img/home1/tour-package-img2.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('frontend/img/home1/tour-package-img10.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('frontend/img/home1/tour-package-img11.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home2/tour-package-img2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img6.jpg') }}" alt="">
                                        </a>
                                        <div class="batch">
                                            <span>Hot Sale!</span>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="package-card">
                                    <div class="package-img-wrap">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="package-content">
        ...
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector1.svg') }}" alt="" class="vector1">
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector2.svg') }}" alt="" class="vector2">
        <img src="{{ asset('frontend/img/home2/vector/home2-package-slider-vector3.svg') }}" alt="" class="vector3">
    </div>
        ...
        <div class="container">
            ...
            <div class="rating-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div class="text-and-logo">
                    ...
                    <a href="http://trustpilot.com/"><img src="{{ asset('frontend/img/home2/icon/trustpilot-logo.svg') }}" alt=""></a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img19.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img20.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img12.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img21.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img22.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="home2-offer-banner-section mb-100">
        <div class="container">
            <div class="offer-banner-wrap">
                ...
                <img src="{{ asset('frontend/img/home2/vector/offer-banner-vector1.svg') }}" alt="" class="vector1">
                <img src="{{ asset('frontend/img/home2/vector/offer-banner-vector2.svg') }}" alt="" class="vector2">
            </div>
        </div>
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img7.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img17.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('frontend/img/home1/tour-package-img18.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="home2-award-banner-section mb-100" style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.25) 100%), url({{ asset('frontend/img/home2/home2-award-banner-bg.jpg') }});">
        <div class="container">
            <div class="banner-content">
            ...
            <div class="partner-wrap">
                <div class="marquee">
                    <div class="marquee__group">
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-01.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-02.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-03.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-04.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-05.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('frontend/img/home1/partner-06.png') }}" alt=""></a>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img1.png') }}" alt="">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img3.png') }}" alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>James Bonde</h5>
                                            <span>GoFly Traveler</span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img2.png') }}" alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>Selina Henry</h5>
                                            <span>GoFly Traveler</span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img4.png') }}" alt="">
                                        </div>
                                        <div class="author-info">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card three">
                                    ...
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('frontend/img/home1/testimonial-author-img5.png') }}" alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>Amber Lashley</h5>
                                            <span>GoFly Traveler</span>
                        ...
                        <div class="row g-2">
                            <div class="col-md-7 mt-70">
                                <div class="single-img justify-content-md-end">
                                    <a data-fancybox="gallery-01" href="{{ asset('frontend/img/home2/gallery-img1-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img1.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="single-img justify-content-md-end">
                                    <a data-fancybox="gallery-01" href="{{ asset('frontend/img/home2/gallery-img2-big.jpg') }}">
                                ...
                                <div class="single-img justify-content-md-between">
                                    ...
                                    <a data-fancybox="gallery-01" href="{{ asset('frontend/img/home2/gallery-img3-big.jpg') }}">
                            ...
                            <div class="col-md-5">
                                <div class="single-img grp-img">
                                    <a data-fancybox="gallery-01" href="{{ asset('frontend/img/home2/gallery-img4-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img4.jpg') }}" alt="">
                                    </a>
                                    <a data-fancybox="gallery-01" href="{{ asset('frontend/img/home2/gallery-img5-big.jpg') }}">
                                        <img src="{{ asset('frontend/img/home2/gallery-img5.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="single-img">
                                    <a data-fancybox="gallery-01" href="{{ asset('frontend/img/home2/gallery-img6-big.jpg') }}">
