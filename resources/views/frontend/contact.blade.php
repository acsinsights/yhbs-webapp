...
@section('content')
    ...
    <div class="breadcrumb-section" style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url({{ asset('frontend/img/innerpages/breadcrumb-bg2.jpg') }})">  
        <div class="container">
  ...
  <iframe
    src="https://www.google.com/maps?q=Dayia%20Tower,%20Sharq,%20Kuwait&output=embed"
    width="100%"
    height="100%"
    style="border:0;"
    allowfullscreen=""
